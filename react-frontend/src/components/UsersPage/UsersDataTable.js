...
const UsersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.remark}</p>
    const tickTemplate4 = (rowData, { rowIndex }) => <i className={`pi ${rowData.isAdmin?"pi-check": "pi-times"}`}  ></i>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="remark" header="remark" body={pTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="isAdmin" header="am the Boss" body={tickTemplate4} style={{ minWidth: "8rem" }} />
